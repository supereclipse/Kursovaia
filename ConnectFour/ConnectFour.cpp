...
// ConnectFour.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CConnectFourApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CConnectFourApp

CConnectFourApp::CConnectFourApp()
{
...
// Единственный объект CConnectFourApp

CConnectFourApp theApp;


// Инициализация CConnectFourApp

BOOL CConnectFourApp::InitInstance()
{
